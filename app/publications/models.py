...
class WOSPublication(models.Model):
    ...
    wos_id = models.CharField('UT (Unique WOS ID)', max_length=256, primary_key=True)
    ...
    published_year = models.IntegerField("Published Year", default=current_year, null=True, blank=True)
    ...
    source = models.CharField('Source', max_length=10, default="WOS")
    su_staff = models.ManyToManyField(SU_Staff, related_name='wos_su_staff', default=None, blank=True, null=True)

    def save(self, *args, **kwargs):
        super().save(*args, **kwargs)

        try:
            scopus_publication = ScopusPublication.objects.get(doi=self.doi)
...
class Publication(models.Model):
    ...
    wos_publication = models.ForeignKey(WOSPublication, on_delete=models.CASCADE, null=True, blank=True,)
    scopus_publication = models.ForeignKey(ScopusPublication, on_delete=models.CASCADE, null=True, blank=True,)
    publication_source = models.CharField('PUBLICATION SOUCE', max_length=20, default="-", choices=PublicationSourceChoices.choices)
