...
#     wos_id = models.CharField('UT (Unique WOS ID)', max_length=256, unique=True, blank=True, null=True)
...
#     eid = models.CharField('EID', max_length=256, unique=True, blank=True, null=True)
...
# class _Publication(models.Model):
